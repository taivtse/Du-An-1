...
public class Phim  implements java.io.Serializable {
    ...
    public Phim(String id, LoaiPhim loaiPhim, String ten, int thoiLuong, int gioiHanTuoi, Date ngayCongChieu, String ngonNgu, String dienVien, String quocGia, String nhaSanXuat, String tomTat, String trangThai, Boolean daXoa, String hinhAnh, Set<SuatChieu> suatChieus) {
       this.id = id;
       this.loaiPhim = loaiPhim;
       this.ten = ten;
       this.thoiLuong = thoiLuong;
